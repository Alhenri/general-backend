const data = [
  {
    ...
    lines: [
      'Projeto inspirando na primeira NLW mas que estou criando no momento. O site está em desenvolvimento, mas a ideia principal é que ele seja uma interface onde será possivel cadastrar/encontrar pontos de coleta próximo a você',
    ],
    links: [
      {
        icon: 'github',
  ...
  },
  {
    ...
    img: 'https://i.imgur.com/lOURw2B.jpg',
    lines: [
    ...
    links: [
      {
        icon: 'external_link',
        url: 'https://www.youtube.com/playlist?list=PLMzWw6fh54Z_nF5NtbNWCphCr78MknrxL',
      },
    ],
  },
  {
    title: 'Projeto de hardware e empreendedorismo',
    img: 'https://i.imgur.com/x4bDCIA.jpg',
    lines: [
